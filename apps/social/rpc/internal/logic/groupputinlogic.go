...
func (l *GroupPutinLogic) GroupPutin(in *social.GroupPutinReq) (*social.GroupPutinResp, error) {
	...
	var (
		inviteGroupMember *socialmodel.GroupMembers
		userGroupMember   *socialmodel.GroupMembers
		groupInfo         *socialmodel.Groups

		err error
	)

	userGroupMember, err = l.svcCtx.GroupMembersModel.FindByGroudIdAndUserId(l.ctx, in.ReqId, in.GroupId)
	if err != nil && err != socialmodel.ErrNotFound {
	...
	groupReq = &socialmodel.GroupRequests{
		ReqId:   in.ReqId,
		GroupId: in.GroupId,
...
func (l *GroupPutinLogic) createGroupReq(groupReq *socialmodel.GroupRequests, isPass bool) (*social.GroupPutinResp, error) {
...
func (l *GroupPutinLogic) createGroupMember(in *social.GroupPutinReq) error {
	groupMember := &socialmodel.GroupMembers{
		GroupId:     in.GroupId,
		UserId:      in.ReqId,
